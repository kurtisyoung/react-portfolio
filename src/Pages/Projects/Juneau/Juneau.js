...
class JuneauPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      paragraph: `Juneau is a residential development being built in the heart of Burnaby. The interactive team designed and developed a teaser website, full website and touchscreen app. I worked on both the full website and touchscreen app, but had a bigger role on the website.
      <br/>
      <br/> 
